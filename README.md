...
a token is used to communicate with other computers on a network

- [ ] What steps can you take in your web apps to keep your data secure?

you can require a a login, and you can also use https requests

- [ ] Describe how web servers work.

web servers respond to front end data requests by sending back end data
